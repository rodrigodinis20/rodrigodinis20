...
public class Keyboard implements KeyListener {
     ...
     *
     * @param key the int of the event to add
     * @param keyboardEventType the type of the event to add
     */
    public void addEventListener(int key, KeyboardEventType keyboardEventType) {
