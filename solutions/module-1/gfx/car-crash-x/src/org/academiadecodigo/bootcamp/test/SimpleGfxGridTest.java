        ...
        try {
            ...
            while (cycles > 0) {
                ...
                if (gridPos.getX() != pos.getCol() * grid.getCellSize() + SimpleGfxGrid.PADDING
                    ...
                    return new TestResult(false, "shape and position coordination is wrong after moving down");
                }
                ...
                if (gridPos.getX() != pos.getCol() * grid.getCellSize() + SimpleGfxGrid.PADDING
                        || gridPos.getY() != pos.getRow() * grid.getCellSize() + SimpleGfxGrid.PADDING) {
                    return new TestResult(false, "shape and position coordination is wrong after moving right");
                }
                ...
                if (gridPos.getX() != pos.getCol() * grid.getCellSize() + SimpleGfxGrid.PADDING
                        || gridPos.getY() != pos.getRow() * grid.getCellSize() + SimpleGfxGrid.PADDING) {
                    return new TestResult(false, "shape and position coordination is wrong after moving up");
                }
                ...
                if (gridPos.getX() != pos.getCol() * grid.getCellSize() + SimpleGfxGrid.PADDING
                        || gridPos.getY() != pos.getRow() * grid.getCellSize() + SimpleGfxGrid.PADDING) {
                    return new TestResult(false, "shape and position coordination is wrong after moving left");
                }
